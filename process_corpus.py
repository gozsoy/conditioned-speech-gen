...
save_dir = '/cluster/scratch/goezsoy/nlp_lss_datasets'
...
agg_df.to_csv(path_or_buf=os.path.join(save_dir,'full-corpus.csv'),index=False)
print('raw corpus reading done')


# 2- PREPROCESSING

df = pd.read_csv(os.path.join(save_dir,'full-corpus.csv'))
...
processed_df.to_csv(os.path.join(save_dir,'processed_df.csv'))
processed_df_train.to_csv(os.path.join(save_dir,'processed_df_train.csv'))
processed_df_valid.to_csv(os.path.join(save_dir,'processed_df_valid.csv'))
