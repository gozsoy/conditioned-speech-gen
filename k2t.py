...
###################################
    ...
    converter_table = np.load('/cluster/scratch/goezsoy/nlp_lss_datasets/converter_table_glove.npy') 
...
def get_keywordsets(task, folder_name, file_name):
    ...
    if task == 'key2article':
        ...
        if task == 'commongen':
            ...
            # below is the one I created whose first keyword is in_text actually
...
if __name__ == '__main__':
    ...
    checkpoint = torch.load('/cluster/scratch/goezsoy/nlp_lss_checkpoints/18aug_k2t_gpt2medium_maxseqlen256_batch8_8_lr2e5_epoch2.pt',map_location=device)
