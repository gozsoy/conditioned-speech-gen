...
os.environ['GENSIM_DATA_DIR']='/cluster/scratch/goezsoy/nlp_lss_datasets' #'./gensim-data'
...
def converter_table_glove():
    ...
    path = '/cluster/scratch/goezsoy/nlp_lss_datasets/converter_table_glove'

    # load gpt-2 model
    #model = GPT2LMHeadModel.from_pretrained('gpt2')
    tokenizer = GPT2Tokenizer.from_pretrained('gpt2', cache_dir='/cluster/scratch/goezsoy/huggingface_cache')
    #model.eval()
